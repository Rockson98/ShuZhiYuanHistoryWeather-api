...
Invoke-RestMethod -Uri "https://shuzhiyuanhistoryweather-api.onrender.com/weather/history?project_id=1"

# 或使用明确的历史日期（例如 7 天前）
$yesterday = (Get-Date).AddDays(-7).ToString("yyyy-MM-dd")
Invoke-RestMethod -Uri "https://shuzhiyuanhistoryweather-api.onrender.com/weather/history?project_id=1&date=$yesterday"
<<<<<<< HEAD
=======
=======
...
```
<<<<<<< HEAD
https://shuzhiyuanhistoryweather-api.onrender.com/weather/history?project_id=1
=======
<<<<<<< HEAD
https://shuzhiyuanhistoryweather-api.onrender.com/weather/history?project_id=1
=======
...
```powershell
<<<<<<< HEAD
$result = Invoke-RestMethod -Uri "https://shuzhiyuanhistoryweather-api.onrender.com/weather/history?project_id=1"
=======
<<<<<<< HEAD
$result = Invoke-RestMethod -Uri "https://shuzhiyuanhistoryweather-api.onrender.com/weather/history?project_id=1"
=======
...
<<<<<<< HEAD
$result = Invoke-RestMethod -Uri "https://shuzhiyuanhistoryweather-api.onrender.com/weather/history?project_id=1&date=$date"
=======
<<<<<<< HEAD
$result = Invoke-RestMethod -Uri "https://shuzhiyuanhistoryweather-api.onrender.com/weather/history?project_id=1&date=$date"
=======
